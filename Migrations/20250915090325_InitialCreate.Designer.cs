...
namespace Mini_LMS.Migrations
{
    ...
    [Migration("20250915090325_InitialCreate")]
            ...
            modelBuilder.Entity("Mini_LMS.Models.CourseTakedownRequest", b =>
                {
                    ...
                    b.HasIndex(new[] { "RequestedBy" }, "RequestedBy1");
            ...
            modelBuilder.Entity("Mini_LMS.Models.Enrollment", b =>
                {
                    ...
                    b.HasIndex(new[] { "CourseId" }, "fk_enroll_course");

                    b.HasIndex(new[] { "LearnerId", "CourseId" }, "uq_learner_course")
                        .IsUnique();
            ...
            modelBuilder.Entity("Mini_LMS.Models.Feedback", b =>
                {
                    ...
                    b.HasIndex(new[] { "CourseId" }, "CourseId2");
            ...
            modelBuilder.Entity("Mini_LMS.Models.Module", b =>
                {
                    ...
                    b.HasIndex(new[] { "CourseId" }, "CourseId3");
            ...
            modelBuilder.Entity("Mini_LMS.Models.Moduleprogress", b =>
                {
                    ...
                    b.HasIndex(new[] { "LearnerId" }, "FK_ModuleProgress_Learner");

                    b.HasIndex(new[] { "ModuleId" }, "FK_ModuleProgress_Module");
