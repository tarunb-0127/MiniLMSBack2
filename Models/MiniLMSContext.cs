...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseMySql("server=localhost;port=3306;database=minilmsdb2;user=root;password=Password@12345", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.41-mysql"));
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Moduleprogress>(entity =>
        {
            ...
            entity.HasIndex(e => e.LearnerId, "FK_ModuleProgress_Learner");

            entity.HasIndex(e => e.ModuleId, "FK_ModuleProgress_Module");
            ...
            entity.HasOne(d => d.Learner).WithMany(p => p.Moduleprogresses)
                .HasForeignKey(d => d.LearnerId)
                .HasConstraintName("FK_ModuleProgress_Learner");
